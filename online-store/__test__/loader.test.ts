...
test("Should return data on correct input", () => {
    ...
    expect(load.getData()).toEqual(require("./mocks/loader/correctReturn.json").spacecrafts);
});
